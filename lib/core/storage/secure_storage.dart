...
//   Future<void> saveTheme(ThemeModeEnum mode) async {
//     await storage.write(key: themeModeKey, value: mode.value);
//   }

//  Future<ThemeModeEnum> loadTheme() async {
//   final value = await storage.read(key: themeModeKey);
//     return fromStorageValue(value); // can be "dark", "light", or "system"
//   }
}
